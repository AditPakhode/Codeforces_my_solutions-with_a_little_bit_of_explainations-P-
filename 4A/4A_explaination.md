...
Only even numbers can be divided into even pieces.

So from starting smallest +ve even number (since weight can't be negative) which is 2 to +ve infinity.

So the range is [2, +ve infinity).
