...
- So, the answer is simple you have to find the largest integer in the array negate all of the other integers except the largest one and add the largest to the rest of the sum of negated integers.